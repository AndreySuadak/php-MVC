...
<meta name="description" content="Афторизация">
...
<?php require 'public/blocks/body_start.php' ?><!-- Первая часть для body и шапки концовка в footer -->
  <main class="px-3 text-warning">
    <h1 id="home_h1">logIn (Афторизация)</h1>
    <p>Here you can log in (Здесь вы можете Афторизироваться)</p>

    <div class="row justify-content-center">
      <div class="col-sm-4">

        <!-- Обработка формы на этой же странице -->
        <form action="/user/auth" method="post" class="bg-transparent text-warning">
        ...
        <?php endif; ?>
          ...
          <button type="submit" class="btn btn-warning fw-bold" id="button">Готово</button>
        </form>

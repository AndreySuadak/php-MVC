...
<title>letters</title>
<meta name="description" content="тренажер английских букв">
...
<main class="px-3 text-whilt">
    <h1 id="home_h1">Trainer of letter</h1>
    <p class="lead" id="home_h1_p">There are many tests where you need to perceive English
      letters by ear. <br>This simulator was designed to make
       this task easier. You can choose any of the simulators.</p>
      ...
      <div class="row text-warning">
        ...
        <div class="col-sm-4 border border-warning rounded-3">
          <div class="card bg-transparent">
            <div class="card-body ">
              <h5 class="card-title" id="first_h5">Letter Perception Trainer</h5>
              <p class="card-text" id="first_h5_p">Here, letter from A to Z will be played in random order.</p><br>
...
<script src="../../../public/js/letter.js" type="text/javascript"></script>
